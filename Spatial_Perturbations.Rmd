...
R250 <- st_as_sf(rasterToPolygons(raster(xmn=min(P[[1]][1]), ymn=min(P[[1]][2]), xmx=max(P[[1]][1]), ymx=max(P[[1]][2]), res=250))) ## ROB NOTE: Do you lose points in other P[[i]]? Because jittered points won't always lie in the bounds of P[[1]]'s coords
